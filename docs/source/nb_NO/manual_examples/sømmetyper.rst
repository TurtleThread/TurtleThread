...
.. include-turtlethread:: sømmetyper/01.py
    :linenos:

Hva skjer hvis vi visualiserer dette?

.. include-turtlethread:: sømmetyper/02.py
    :linenos:
    :emphasize-lines: 5

.. image:: sømmetyper/manual_code_output/02.svg
  :width: 10
...
.. include-turtlethread:: sømmetyper/03.py
    :linenos:

.. literalinclude:: sømmetyper/manual_code_output/pattern_no_stitch.txt
...
.. include-turtlethread:: sømmetyper/04.py
    :linenos:
    :emphasize-lines: 4

.. image:: sømmetyper/manual_code_output/04.svg
  :width: 100
  :alt: Resultat fra koden over.
    En horisontal blå strek med fire korte vertikale streker med lik avstand mellom hver strek.
  :class: sphx-glr-script-out

.. literalinclude:: sømmetyper/manual_code_output/pattern_running_stitch_20.txt
...
.. include-turtlethread:: sømmetyper/05.py
    :linenos:
    :emphasize-lines: 4

.. image:: sømmetyper/manual_code_output/05.svg
  :width: 100
  :alt: Resultat fra koden over.
    En horisontal blå strek med tre korte vertikale streker, en i hver ende og en på midten.
  :class: sphx-glr-script-out

.. literalinclude:: sømmetyper/manual_code_output/pattern_running_stitch_30.txt
...
.. include-turtlethread:: sømmetyper/06.py
    :linenos:
    :emphasize-lines: 6-7

.. image:: sømmetyper/manual_code_output/06.svg
  :width: 100
  :alt: Resultat fra koden over.
...
.. literalinclude:: sømmetyper/manual_code_output/pattern_angle.txt
...
.. include-turtlethread:: sømmetyper/07.py
    :linenos:
    :emphasize-lines: 5-7

.. image:: sømmetyper/manual_code_output/07.svg
  :width: 100
  :alt: Resultat fra koden over.
...
.. include-turtlethread:: sømmetyper/08.py
    :linenos:
    :emphasize-lines: 6-7

.. image:: sømmetyper/manual_code_output/08.svg
  :width: 100
  :alt: Resultat fra koden over.
    En horisontal blå strek med tre korte vertikale streker, en i hver ende og en på midten.
  :class: sphx-glr-script-out
...
.. include-turtlethread:: sømmetyper/09.py
    :linenos:
    :emphasize-lines: 8-10

.. image:: sømmetyper/manual_code_output/09.svg
  :width: 100
  :alt: Resultat fra koden over.
...
.. literalinclude:: sømmetyper/manual_code_output/pattern_jump.txt
  :emphasize-lines: 4-5
...
.. include-turtlethread:: sømmetyper/10.py
    :linenos:
    :emphasize-lines: 4

Det samme som 

.. include-turtlethread:: sømmetyper/11.py
    :linenos:
    :emphasize-lines: 4,6
