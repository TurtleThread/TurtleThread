...
.. include-turtlethread:: fraktal/01.py
    :linenos:
    :emphasize-lines: 5, 9, 14, 19

.. image:: fraktal/manual_code_output/01.svg
  :width: 180
...
.. include-turtlethread:: fraktal/03_2.py
    :linenos:
    :emphasize-lines: 3-5, 8, 12, 17, 22, 26

.. image:: fraktal/manual_code_output/03_2.svg
  :width: 180
...
.. image:: fraktal/manual_code_output/03_0.svg
    :width: 180
    :alt: En rett strek

.. collapse:: Kode:

    .. include-turtlethread:: fraktal/03_0.py
        :linenos:

**Rekursjonsnivå 1**

.. image:: fraktal/manual_code_output/03_1.svg
    :width: 180
    :alt: Den samme snøflak-armen som ble tegnet i første kodeeksempel.

.. collapse:: Kode:

    .. include-turtlethread:: fraktal/03_1.py
        :linenos:
...
.. admonition:: Prøv selv:
    ...
    * Endre slik at hver arm har to sett med grener. Nedenfor er en visualisering av hvordan det kan se ut.
    ...
    .. image:: fraktal/manual_code_output/05.svg
        :width: 180
    ...
    .. collapse:: Klikk her for å se programmet slik det kan være om du har gjort det rett:
        ...
        .. include-turtlethread:: fraktal/05.py
            :linenos:
...
.. image:: fraktal/manual_code_output/gallery01_1.svg
    :width: 180
    :alt: Et annet type fraktalt snøflak kalt "Koch-snøflaket".
    :class: randomness-gallery-arm

.. image:: fraktal/manual_code_output/gallery01_2.svg
    :width: 180
    :alt: Et annet type fraktalt snøflak kalt "Koch-snøflaket".
    :class: randomness-gallery-arm
...
.. collapse:: Kode for rekursjonsnivå 1
    ...
    .. include-turtlethread:: fraktal/gallery01_1.py
        :linenos:

.. collapse:: Kode for rekursjonsnivå 2
    :class: randomness-gallery-code

    .. include-turtlethread:: fraktal/gallery01_2.py
        :linenos:

**Eksempelfraktal 2**

.. image:: fraktal/manual_code_output/gallery02_1.svg
    :height: 180
    :alt: Et fraktalt tre.
    :class: randomness-gallery-arm

.. image:: fraktal/manual_code_output/gallery02_3.svg
    :height: 180
    :alt: Et fraktalt tre.
    :class: randomness-gallery-arm
...
.. collapse:: Kode for rekursjonsnivå 1
    ...
    .. include-turtlethread:: fraktal/gallery02_1.py
        :linenos:

.. collapse:: Kode for rekursjonsnivå 3
    :class: randomness-gallery-code

    .. include-turtlethread:: fraktal/gallery02_3.py
        :linenos:

**Eksempelfraktal 3**

.. image:: fraktal/manual_code_output/gallery03_2.svg
    :width: 180
    :alt: Et fraktalt snøflak med to forskjellige arm-typer, et for partals-rekursjonsnivå og ett for oddetalls rekursjonsnivå.
    :class: randomness-gallery-arm

.. image:: fraktal/manual_code_output/gallery03_3.svg
    :width: 180
    :alt: Et fraktalt snøflak med to forskjellige arm-typer, et for partals-rekursjonsnivå og ett for oddetalls rekursjonsnivå.
    :class: randomness-gallery-arm
...
.. collapse:: Kode for rekursjonsnivå 2
    ...
    .. include-turtlethread:: fraktal/gallery03_2.py
        :linenos:

.. collapse:: Kode for rekursjonsnivå 3
    :class: randomness-gallery-code

    .. include-turtlethread:: fraktal/gallery03_3.py
        :linenos: