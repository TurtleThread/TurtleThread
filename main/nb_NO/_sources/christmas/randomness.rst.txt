...
.. image::  /../../_static/figures/manual_examples/randomness/ordered_starscape.svg
    :width: 49.5%
    :alt: En enkel uniform stjernehimmel.

.. image::  /../../_static/figures/manual_examples/randomness/random_starscape.svg
    :width: 49.5%
    :alt: En enkel stjernehimmel med tilfeldige plasserte stjerner.
...
.. image:: /../../_static/figures/manual_examples/randomness/embroidered_random_stars.jpg
    :width: 400
    :alt: Et bilde av broderi av en tilfeldig stjernehimmel.
    ...
    .. collapse:: Klikk her for å se programmet slik det skal være om du har gjort det rett:
        ...
        .. image:: randomness/manual_code_output/07.svg
            ...
            :alt: Resultat fra koden over.
                ...
                Nå er stjernene koblet sammen med en rød strek som symboliserer at nåla skal "hoppe over" denne biten.
                Det er også ett svart kryss i starten av hver røde strek, som symbolserer at tråden skal kuttes der og en rød sirkel i enden av hver røde strek som symboliserer at det er dit nåla skal hoppe.
            :class: sphx-glr-script-out

.. image:: /../../_static/figures/manual_examples/randomness/embroidered_random_stars_action.jpg
    :width: 400
    :alt: Et bilde av broderimaskinen mens den lager en tilfeldig stjernehimmel.
